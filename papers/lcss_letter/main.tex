...
\graphicspath{{../../tier1_sheaf/results/}{../../tier2_drake/results/s1/}}
...
%% AUTHOR: motivation from estimation_sheaf.tex §1 — cable-coupled multi-agent
%% estimation; the constraint channel; delayed fusion through shape-conjugated
%% transports. One paragraph on why the ROUND TRIP is the natural object.

\section{Setting and main result}
%% AUTHOR: Thm 7.2 statement verbatim with its tag:
%% [Proved here] "(leading order, deterministic; sharp constants and the
%% stochastic steady-state floor: [Conjectural])" — the hedge is load-bearing.
%% Lem 7.1 (BCH) supporting statement.
